<?php namespace App\Http\Controllers;
	...
	class AdminTourPicturesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Title','name'=>'alt_tag','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			$this->form[] = ['label'=>'Picture','name'=>'picture','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Title','name'=>'alt_tag','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'radio','validation'=>'required|integer|min:0','width'=>'col-sm-10','dataenum'=>'1|Active;0|inactive'];
			# OLD END FORM
