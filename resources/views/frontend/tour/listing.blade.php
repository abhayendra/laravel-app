    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb-my">
                ...
                <li><a href="{!! url(Request::segment(1).'/all') !!}">{!! ucfirst(Request::segment(1)) !!}</a></li>
                <li class="active">{{ ucfirst(urldecode(Request::segment(2))) }}</li>
            </ol>
            <div class="page">
            </div>
            <div class="view_link">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 col-lg-push-3 col-md-push-3 col-sm-push-3">
                ...
                <div class="mid_listing">
                    <div class="result_heading">{!! ucfirst(urldecode($keyword)) !!}  @if($keyword!="all") & Around @endif  Tours, Tickets & Activities</div>
                    <div class="line2"></div>
