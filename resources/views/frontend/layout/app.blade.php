...
<head>
    ...
    <title>{!! $setting['appname'] !!}:{!! $setting['title'] !!} </title>
    @if(Request::segment(1)=="blog")
        {!! Html::style('resources/assets/css/blog.css') !!}
    @elseif(Request::segment(1)=="forum")
        {!! Html::style('resources/assets/css/forum.css') !!}
    @else
    ...
    {!! Html::style('resources/assets/css/new.css') !!}
    {!! Html::style('resources/assets/css/responsive-tabs.css') !!}
    {!! Html::style('resources/assets/css/ashutosh.css') !!}
            ...
            <nav id="navigation" class="navigation navigation-landscape">
                <div class="nav-header">
                    <a class="navbar-brand" href="{!! url('/') !!}">
                        {!! Html::image('public/'. $setting['logo'], $setting['appname'],['class'=>'img-res logo']) !!}
                    </a>
                ...
                <div class="nav-menus-wrapper my_nav" style="transition-property: none;">
                    {!! Html::image('public/'. $setting['logo'], $setting['appname'],['class'=>'img-res logo_mob']) !!}
                    <div class="mob_sigin">
                        @if(Auth::check())
                    ...
                    <ul class="nav-menu nav navbar-nav">
                        ...
                        <li class="active"><a href="{!! url($menu->url) !!}">{!! ucfirst($menu->name) !!}</a></li>
                        @endforeach
                    </ul>
...
<div class="footer_wra">
    <div class="container-fluid">
        ...
        <div class="f_column">
          {!! $setting['footer_section_3'] !!}
        </div>
        <div class="f_column">
            {!! $setting['footer_section_4'] !!}
        </div>
        <div class="f_column">
            <div class="title">MOBILE APP</div>
            {!! Html::image('resources/assets/images/gplay.png','') !!}
            {!! Html::image('resources/assets/images/app_store.png','') !!}
            <div class="lan">
                <select>
...
{!! Html::script('resources/assets/js/jquery.responsiveTabs.js') !!}
