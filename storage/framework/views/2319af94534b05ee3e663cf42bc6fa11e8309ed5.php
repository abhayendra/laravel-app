                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="heading<?php echo $f->id; ?>">
                                        <h4 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $f->id; ?>" aria-expanded="false" aria-controls="collapse<?php echo $f->id; ?>">
                                              <?php echo $f->question; ?>

                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapse<?php echo $f->id; ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading<?php echo $f->id; ?>">
