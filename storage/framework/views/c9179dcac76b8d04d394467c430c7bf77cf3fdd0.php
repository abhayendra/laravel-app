<?php $__env->startSection('content'); ?>
        ...
        <form class="form-horizontal" method="post" id="form" enctype="multipart/form-data" action="http://localhost/booktours/admin/tours/add-save">
            <input type="hidden" name="_token" value="l77f2LgG2iXLyWoJeBEvPzVDcQPxMj3a7ZwsuFcT">
                ...
                <div class="form-group header-group-0 " id="form-group-category_id" style="">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="category_id" required name="category_id" >
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catId=>$catName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group header-group-0 " id="form-group-province" style="">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" id="province" data-value="" required="" name="province">
    ...
    <link rel='stylesheet' href='http://localhost/booktours/public/vendor/crudbooster/assets/select2/dist/css/select2.min.css'/>
    <style type="text/css">
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/booktours/public/vendor/crudbooster/assets/summernote/summernote.css">
    <style type="text/css">
    ...
    <script src='http://localhost/booktours/public/vendor/crudbooster/assets/select2/dist/js/select2.full.min.js'></script>
    <script type="text/javascript" src="http://localhost/booktours/public/vendor/crudbooster/assets/summernote/summernote.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        var address_temp_tour_from, latitude_temp_tour_from, longitude_temp_tour_from;

        function setIttour_from() {
            console.log(address_temp_tour_from);
            $('#tour_from').val(address_temp_tour_from);
            $("#input-latitude-tour_from").val(latitude_temp_tour_from);
            $("#input-longitude-tour_from").val(longitude_temp_tour_from);
        }

        var is_init_map_tour_from = false;

        function showMapModaltour_from() {
            var api_key = "AIzaSyDLbEcMWRcu1ENEfKU_hJtAGeVZkZkqDss";
            ...
            $('#googlemaps-modal-tour_from').modal('show');
        }

        $('#googlemaps-modal-tour_from').on('shown.bs.modal', function () {
            if (is_init_map_tour_from == false) {
                console.log('Init Map tour_from');
                initMap3();
                is_init_map_tour_from = true;
            }
        });
        ...
        function initMap3() {
            ...
            var map = new google.maps.Map(document.getElementById('map-tour_from'), {
                zoom: 12
            });
            ...
            var input = /** @type        {!HTMLInputElement} */(
                document.getElementById('input-search-autocomplete-tour_from'));

            var types = document.getElementById('type-selector-tour_from');
            ...
            latitude_temp_tour_from = 0;
            longitude_temp_tour_from = 0;
            var pos = {
                lat: latitude_temp_tour_from,
                lng: longitude_temp_tour_from
            };
            map.setCenter(pos);
            map.setZoom(1);
            ...
            google.maps.event.addListener(marker_default_location, 'dragend', function (marker_default_location) {
                ...
                geocoder.geocode({
                    ...
                    address_temp_tour_from = address;

                    infoWindow.setContent(address);

                    $('#current-location-span-tour_from').text(address);
                ...
                latitude_temp_tour_from = latitude;
                longitude_temp_tour_from = longitude;
    ...
    <script type="text/javascript">
        ...
        var address_temp_tour_location, latitude_temp_tour_location, longitude_temp_tour_location;

        function setIttour_location() {
            console.log(address_temp_tour_location);
            $('#tour_location').val(address_temp_tour_location);
            $("#input-latitude-tour_location").val(latitude_temp_tour_location);
            $("#input-longitude-tour_location").val(longitude_temp_tour_location);
        }

        var is_init_map_tour_location = false;

        function showMapModaltour_location() {
            var api_key = "AIzaSyDLbEcMWRcu1ENEfKU_hJtAGeVZkZkqDss";
            ...
            $('#googlemaps-modal-tour_location').modal('show');
        }

        $('#googlemaps-modal-tour_location').on('shown.bs.modal', function () {
            if (is_init_map_tour_location == false) {
                console.log('Init Map tour_location');
                initMap4();
                is_init_map_tour_location = true;
            }
        });
        ...
        function initMap4() {
            geocoder = new google.maps.Geocoder();
            var map = new google.maps.Map(document.getElementById('map-tour_location'), {
                zoom: 12
            });
            ...
            var input = /** @type        {!HTMLInputElement} */(
                document.getElementById('input-search-autocomplete-tour_location'));

            var types = document.getElementById('type-selector-tour_location');
            map.controls[google.maps.ControlPosition.TOP_LEFT].push(input);
            map.controls[google.maps.ControlPosition.TOP_LEFT].push(types);
            ...
            latitude_temp_tour_location = 0;
            longitude_temp_tour_location = 0;
            var pos = {
                lat: latitude_temp_tour_location,
                lng: longitude_temp_tour_location
            };
            map.setCenter(pos);
            map.setZoom(1);
            ...
            google.maps.event.addListener(marker_default_location, 'dragend', function (marker_default_location) {
                ...
                geocoder.geocode({
                    ...
                    address_temp_tour_location = address;

                    infoWindow.setContent(address);

                    $('#current-location-span-tour_location').text(address);
                ...
                latitude_temp_tour_location = latitude;
                longitude_temp_tour_location = longitude;
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function uploadImageoverview(image) {
                ...
                $.ajax({
                    url: 'http://localhost/booktours/admin/tours/upload-summernote',
                    cache: false,
                    contentType: false,
                    processData: false,
                    data: data,
                    ...
                    success: function (url) {
                        ...
                        $('#textarea_overview').summernote("insertNode", image[0]);
                    },
                    error: function (data) {
                        console.log(data);
                    }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#textarea_itinerary').summernote({
                ...
                callbacks: {
                    onImageUpload: function (image) {
                        uploadImageitinerary(image[0]);
                    }
                }
            });
            function uploadImageitinerary(image) {
                var data = new FormData();
                data.append("userfile", image);
                $.ajax({
                    url: 'http://localhost/booktours/admin/tours/upload-summernote',
                    ...
                    success: function (url) {
                        var image = $('<img>').attr('src', url);
                        $('#textarea_itinerary').summernote("insertNode", image[0]);
                    },
                    error: function (data) {
                        console.log(data);
                    }
