                ...
                <div class="nav-menus-wrapper my_nav" style="transition-property: none;">
                    ...
                    <div class="mob_sigin">
                        ...
                        <div class="user_name"><a href="<?php echo url('dashboard'); ?>"><span>
                          <img src="http://booktours.ca/resources/assets/images/ajay.jpg" alt="" class="img-res"></span> Hello, <?php echo Auth::user()->name; ?>!</a>
                          <ul>
                        ...
                        <ul class="round_btn">
                            ...
                            <li><a href="#"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span><?php echo @$cartCollection->count(); ?></span></a></li>
                        </ul>
...
<div class="footer_wra2">
    <div class="container-fluid">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="footer_matter">
                        ...
                        <p>
                          ...
                          <?php $__currentLoopData = $featureTour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ftKey=>$ftValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <a href="<?php echo url('/location/'.$ftValue); ?>"><?php echo $ftValue; ?></a>  |
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         </p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="footer_matter">
                        ...
                        <p>
                          ...
                          <?php $__currentLoopData = $searchResult; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ftKey=>$ftValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <a href="<?php echo url('/location/'.$ftValue); ?>"><?php echo $ftValue; ?></a>|
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </p>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="copyright">
                    Copyright © <?php echo date('Y'); ?> <?php echo $setting['appname']; ?> . All rights reserved. <br>
                    Terms and Conditions.
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="certificate">
                    <a href="#"><?php echo Html::image('resources/assets/images/certificate1.png','Logo'); ?></a>
                    <a href="#"><?php echo Html::image('resources/assets/images/certificate2.png','Logo'); ?></a>
                    <a href="#"><?php echo Html::image('resources/assets/images/certificate3.png','Logo'); ?></a>
                </div>
            </div>
        </div>
    </div>
