<?php $__env->startSection('content'); ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo asset('vendor/crudbooster/assets/summernote/summernote.css'); ?>">
    <!-- Your html goes here -->
                        ...
                        <table class="row" id="dataTable" width="100%" >
                            ...
                            <td>
                                <select name="traveler_type[]" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $travelerType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $traveler): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo $traveler->id; ?>"><?php echo $traveler->name; ?> <?php echo $traveler->age_group; ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </td>
                            <td>
    ...
    <link rel="stylesheet" href="<?php echo asset('vendor/crudbooster/assets/adminlte/plugins/timepicker/bootstrap-timepicker.min.css'); ?>">
    <script src="<?php echo asset('vendor/crudbooster/assets/adminlte/plugins/timepicker/bootstrap-timepicker.min.js'); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo asset('vendor/crudbooster/assets/summernote/summernote.min.js'); ?>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function uploadImagedescription(image) {
                ...
                $.ajax({
                    url: '<?php echo url('tour/upload-summernote'); ?>',
                    cache: false,
                    contentType: false,
                    processData: false,
                    data: data,
