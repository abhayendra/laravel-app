                    ...
                    <div class="book_right_wra" data-spy="affix" data-offset-top="497">
                        ...
                        <div class="booking_box">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
                                ...
                                <?php $__currentLoopData = $tour->tourPrice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <label><?php echo $price->type; ?> ( CA$ <?php echo $price->prices; ?> )</label>
                                        <div class="input-group">
                                          <span class="input-group-btn">
                                              <button type="button" class="btn btn-default btn-number" disabled="disabled" data-type="minus" data-field="travelers[<?php echo $price->type; ?>]">
                                                  <span class="glyphicon glyphicon-minus"></span>
                                              </button>
                                          </span>

                                          <input type="text" name="travelers[<?php echo $price->type; ?>]" class="form-control input-number" value="<?php echo $price->min; ?>" min="<?php echo $price->min; ?>" max="<?php echo $price->max; ?>">

                                          <span class="input-group-btn">
                                              <button type="button" class="btn btn-default btn-number" data-type="plus" data-field="travelers[<?php echo $price->type; ?>]">
