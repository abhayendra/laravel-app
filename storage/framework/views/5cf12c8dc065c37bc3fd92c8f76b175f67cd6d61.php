        ...
        <div class="col-lg-12">
            ...
            <div class="short_wra" id="short_by">
                ...
                <select class="sortby" id="shortBy">
                    <option <?php echo e($order == 'relevance' ? ' selected' : ''); ?> value="<?php echo url(Request::segment(1).'/'.$categoryName.'?order=relevance'); ?>">Relevance</option>
                    <option <?php echo e($order == 'new' ? ' selected' : ''); ?> value="<?php echo url(Request::segment(1).'/'.$categoryName.'?order=new'); ?>">New &amp; Popular</option>
                    <option <?php echo e($order == 'review_high' ? ' selected' : ''); ?> value="<?php echo url(Request::segment(1).'/'.$categoryName.'?order=review_high'); ?>">Reviews - high to low</option>
                    <option <?php echo e($order == 'review_low' ? ' selected' : ''); ?> value="<?php echo url(Request::segment(1).'/'.$categoryName.'?order=review_low'); ?>">Reviews - low to high</option>
                    <option <?php echo e($order == 'price_high' ? ' selected' : ''); ?> value="<?php echo url(Request::segment(1).'/'.$categoryName.'?order=price_high'); ?>">Price - high to low</option>
                    <option <?php echo e($order == 'price_low' ? ' selected' : ''); ?> value="<?php echo url(Request::segment(1).'/'.$categoryName.'?order=price_low'); ?>">Price - low to high</option>
                    <option <?php echo e($order == 'duration_high' ? ' selected' : ''); ?> value="<?php echo url(Request::segment(1).'/'.$categoryName.'?order=duration_high'); ?>">Duration - high to low</option>
                    <option <?php echo e($order == 'duration_low' ? ' selected' : ''); ?> value="<?php echo url(Request::segment(1).'/'.$categoryName.'?order=duration_low'); ?>">Duration - low to high</option>
                </select>
            </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 col-lg-push-3 col-md-push-3 col-sm-push-3">
                <div class="mid_listing">
                    <div class="result_heading">Category: <?php echo $categoryName; ?></div>
                    <div class="line2"></div>
